...
ActiveRecord::Schema.define(version: 20180529043910) do
  ...
  create_table "like_relationships", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["micropost_id"], name: "index_like_relationships_on_micropost_id", using: :btree
    t.index ["user_id", "micropost_id"], name: "index_like_relationships_on_user_id_and_micropost_id", unique: true, using: :btree
